...
export const menu: MenuItem[] = [
  ...
  { id: "md-s-d", name: "Medialunas Simples — docena", desc: "Manteca, doradas.", price: 9000, category: "panaderia", badge: "Favorito" },
  { id: "md-s-m", name: "Medialunas Simples — ½ docena", desc: "Pack 6 unidades.", price: 5000, category: "panaderia" },
  { id: "md-r-d", name: "Medialunas Rellenas — docena", desc: "Rellenas artesanales.", price: 10000, category: "panaderia" },
  { id: "md-r-m", name: "Medialunas Rellenas — ½ docena", desc: "Pack 6 unidades.", price: 6000, category: "panaderia" },
  { id: "md-jq-d", name: "Medialunas JyQ — docena", desc: "Con jamón y queso.", price: 12000, category: "panaderia" },
